...
{
    return (
        <div className="w-[530px] h-[672px] bg-[#FACC15] opacity-100 rounded-[40px] flex flex-col items-center justify-center gap-3 m-[15px]">
            ...
            <div className="bg-[#FFFFFF] w-[250] h-[60.4205322265625] rounded-[35px] flex items-center justify-center relative -top-5">
                <Link href={link} className="font-inter font-normal text-[24px] leading-[100%] tracking-normal">Discover more</Link>
            </div>
