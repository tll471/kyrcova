...
export function Card({image, title, text, link}: Props) {
    return (
        <div className="w-[90vw] max-w-[530px] h-auto sm:h-[672px] bg-[#FACC15] opacity-100 rounded-[40px] flex flex-col items-center justify-center gap-3 m-[15px] shrink-0 snap-center relative pt-6 pb-6 overflow-hidden">
            <div className="bg-[#000000] absolute inset-x-0 top-0 h-[55%] sm:h-168 sm:w-[530px] z-1 rounded-tl-[40px] rounded-tr-[40px] sm:-mt-55"></div>
            <img src={image} alt="picture" className="w-[80%] sm:w-[433px] h-auto sm:h-[452px] mb-auto z-2 sm:-mt-6 relative"/>
