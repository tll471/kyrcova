    ...
    return (
        <div className="w-[90vw] sm:w-[1650px] flex flex-col justify-between mx-auto mt-20">
            <div className="flex flex-col sm:flex-row w-full justify-between gap-4 sm:gap-0 items-center">
                ...
                <div className="fixed bottom-5 left-1/2 -translate-x-1/2 sm:static sm:translate-x-0 border-[2px] rounded-[23px] flex flex-row w-[390px] h-[46px] justify-around bg-white z-50 shadow-md sm:shadow-none">
            ...
            <div className="flex flex-wrap justify-center sm:justify-start gap-8 mt-10">
                {cards.map((card, index) => (
                    <div key={index} className="w-[90vw] sm:w-[388px] h-[491px] rounded-[30px] bg-[#FFFFFF] shadow-[0_0_8px_rgba(0,0,0,0.5)]">
                        ...
                        <div className="flex flex-col mt-3">
                            <p className="text-black font-semibold text-[26.35px] leading-none text-center font-inter">{card.title}</p>
            ...
            <div className="flex flex-row gap-5 mx-auto mt-15 mb-24 sm:mb-0">
                ...
                <Link href='/Pages/primeAndroid' className="font-inter font-medium text-[25.59px] leading-none tracking-normal text-[#6D28D9]">3</Link>
