    ...
    return(
        <div className="mt-25 flex flex-col w-[1600px] justify-around m-0 m-auto items-center max-w-[390px] sm:max-w-none sm:flex-row">
            ...
            <div className="flex flex-col w-[336px] justify-around items-center sm:items-start sm:w-[782px] gap-5 sm:gap-7">
                ...
                <p className="text-left sm:text-left font-semibold text-[20px] leading-none tracking-normal font-Inter">Discover the exciting world of RobBrick robotics. <br></br>Learn programming, engineering, <br></br> and creative problem-solving through hands-on projects and interactive lessons.</p>
