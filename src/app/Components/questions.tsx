...
{
    return(
        <div className="flex flex-col sm:flex-row mt-40 sm:mt-40 w-full sm:w-[1650px] max-w-[1650px] m-auto gap-10 sm:gap-30 items-center sm:items-start justify-around px-4 text-center sm:text-left">
            <div className="flex flex-col items-center sm:items-start">
                <p className="font-['Inter'] font-semibold text-[32px] sm:text-[50px] leading-tight sm:leading-none tracking-normal">Frequently Asked Questions</p>
